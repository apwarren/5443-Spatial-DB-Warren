...
def main():
    ...
    "Please choose one of the menu options...", formatter=menu_format)

    function_start = FunctionItem("START",start)
    function_genfleet = FunctionItem("GENERATE FLEET",generate_Fleet)
    function_getCurrentGames = FunctionItem("GET CURRENT GAMES",get_CurrentGames)
    function_getloc = FunctionItem("GET BATTLE LOCATION",getLoc)
    ...
    function_fireguns = FunctionItem("FIRE GUNS",fireGuns)
    

    menu.append_item(function_start)
    menu.append_item(function_genfleet)
    menu.append_item(function_getCurrentGames)
    menu.append_item(function_getloc)
    menu.append_item(function_posfleet)
    menu.append_item(function_shipspeed)
    menu.append_item(function_turnships)
    menu.append_item(function_fireguns)
